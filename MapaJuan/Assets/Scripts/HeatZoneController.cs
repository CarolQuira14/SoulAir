...
public class HeatZoneController : MonoBehaviour
{
    ...
    [Header("Configuraci�n de Material")]
    ...
    {
        // Convertir coordenadas GPS a posici�n local
        Vector2 localPos = coordinateConverter.ZoomMapPositionParticles(sensorCoords);

        // Aplicar posici�n al sistema de part�culas
    ...
    void UpdateParticleProperties()
    {
        ...
        // Transici�n gradual de color CON opacidad
